...
** Last update Sun Apr 13 22:17:58 2014 chalie_a
*/
...
int			the_game_is_over(t_champ *, t_arena *, t_settings *);
...
int			shw_list(t_champ *);
void			display_arena(char *, int);
void			display_sets(t_settings *);
int			start_battle(t_champ *, t_arena *, t_settings *);
int			exec_command(t_champ *, t_arena *);
int			delete_elem(t_champ *, t_arena *);
int			print_map(t_champ *, t_arena *);
